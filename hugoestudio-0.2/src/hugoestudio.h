...
public:
    ...
    void OnMovRec( wxCommandEvent& event );
    void OnMovAce( wxCommandEvent& event );
    void OnParab( wxCommandEvent& event );
    
    void OnTempe( wxCommandEvent& event );
    void OnMol( wxCommandEvent& event );
    void OnVol( wxCommandEvent& event );
